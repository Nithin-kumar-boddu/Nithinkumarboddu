...
// ============================================
//  EDIT YOUR CONTACT EMAIL HERE
// ============================================
const CONTACT_EMAIL = 'nithinkumarpersonal@gmail.com';
// ============================================
...
const Contact = () => {
  ...
  // Handle form submission — opens the user's mail client via mailto:
  // (No backend is wired. This is a non-functional placeholder; replace with
  //  a real form service like Formspree/Resend if you want real submissions.)
    ...
    <section ref={ref} id="contact" className="bg-[#0b0b0b] w-full min-h-screen relative overflow-hidden flex items-end pt-32 pb-0 border-t border-white/10 select-none">
      ...
      <div className="relative z-10 w-full flex justify-end items-end">
        ...
        >
          ...
          <div className="mb-8 md:mb-12 p-6 bg-black/40 backdrop-blur-xl border border-white/10 rounded-xl">
            <h3 className="text-lg md:text-xl font-black text-white mb-3">Have an idea worth building?</h3>
            <p className="text-white/80 font-light leading-relaxed mb-4">
              I'm interested in building practical software products, developing full-stack applications, exploring useful AI/ML applications, and working with businesses or teams that want to turn ideas into usable software.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 text-xs font-mono text-white/60">
              <span className="px-3 py-1 bg-red-600/10 border border-red-600/30 rounded">Open to AI Product Engineering roles</span>
              <span className="px-3 py-1 bg-white/5 border border-white/10 rounded">Software engineering opportunities</span>
              <span className="px-3 py-1 bg-white/5 border border-white/10 rounded">Product / startup collaborations</span>
              <span className="px-3 py-1 bg-white/5 border border-white/10 rounded">Selected freelance & MVP projects</span>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-12 mt-4 pt-6 border-t border-white/10">
              ...
              <div className="flex-1 flex flex-col gap-8 text-xs text-white/50 font-light">
                <p className="leading-relaxed max-w-[400px]">
                  Form is a non-functional placeholder. Submitting opens your mail client to send a message directly.
                </p>
