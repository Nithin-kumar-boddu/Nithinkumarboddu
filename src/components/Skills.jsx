...
// ============================================
//  SKILLS — 4-Tier Honest Hierarchy
// ============================================
const skillCategories = [
  {
    title: 'Full-Stack Software Development',
    desc: 'Building complete web applications across frontend, backend, APIs, databases, authentication, application logic, and business workflows.',
    tag: 'FULL-STACK DEVELOPMENT',
    skills: ['HTML / CSS', 'JavaScript', 'TypeScript', 'React', 'Next.js', 'Node.js', 'REST APIs', 'PostgreSQL', 'MongoDB', 'Authentication', 'Git / GitHub']
  },
  {
    title: 'Product Engineering & MVP Development',
    desc: 'Turning ideas and requirements into usable software products. Focused on practical architecture, rapid implementation, iteration, debugging, and delivering working MVPs.',
    tag: 'PRODUCT ENGINEERING',
    skills: ['MVP Development', 'Rapid Prototyping', 'Product Iteration', 'Requirements Analysis', 'Application Architecture', 'API Integration', 'Business Workflows', 'Debugging', 'Deployment']
  },
  {
    title: 'Practical AI / ML',
    desc: 'Building practical AI/ML projects and integrating AI capabilities into software where they provide useful product value. Product-focused application development rather than ML research.',
    tag: 'PRACTICAL AI / ML',
    skills: ['Python', 'Machine Learning', 'AI Applications', 'AI APIs', 'Model Experimentation', 'Prompt Engineering', 'AI-Assisted Development']
  },
  {
    title: 'AI-Assisted & Agentic Development',
    desc: 'Using modern AI coding models and agentic development workflows to accelerate implementation, debugging, experimentation, and product iteration. A key part of my rapid-development workflow.',
    tag: 'AI-ASSISTED DEVELOPMENT',
    skills: ['AI Coding Tools', 'Agentic Development', 'AI-Assisted Debugging', 'Rapid Implementation', 'Codebase Iteration', 'Rapid Prototyping']
  }
];
...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      ref={sectionRef}
      className="relative w-full min-h-[100svh] md:h-screen bg-[#0b0b0b] text-white md:overflow-hidden flex items-center justify-center md:[perspective:1000px] select-none"
    >
