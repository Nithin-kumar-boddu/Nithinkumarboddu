...
import pictureImg from '../assets/Portfolio/ChatGPT Image Sep 3, 2026, 01_50_53 PM.png';

// ============================================
//  EDIT YOUR INFO HERE
// ============================================
const YOUR_NAME = 'Nithin Kumar Boddu';
const YOUR_NAME_FIRST = 'Nithin';
const YOUR_NAME_MIDDLE = 'Kumar';
const YOUR_NAME_LAST = 'Boddu';
const YOUR_TAGLINE = 'AI PRODUCT ENGINEER';
const YOUR_ROLE = 'AI Product Engineer & Software Product Builder';
const YOUR_BIO = 'I build practical software products, websites, and MVPs end-to-end. From understanding the idea and designing the solution to developing the frontend, backend, database, and AI-powered features where useful.';
const YOUR_STACK = ['Full-Stack Development', 'Product Engineering', 'AI / ML'];
const YOUR_AWARDS = 'Building software products, websites, MVPs, practical AI/ML projects, and real-world client solutions through independent development and AscendDigital.';
// ============================================
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-5 text-left">
            ...
            <h1 className="hero-anim-item text-5xl md:text-7xl font-black tracking-tighter leading-[0.95] drop-shadow-[0_15px_30px_rgba(0,0,0,0.9)]">
              <span className="block">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-rose-600 to-red-700 drop-shadow-[0_0_35px_rgba(220,38,38,0.5)]">{YOUR_NAME_FIRST}</span>
                <span className="text-white"> {YOUR_NAME_MIDDLE}</span>
              </span>
